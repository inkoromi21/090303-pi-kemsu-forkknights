  ...
  public Konovalov() {
    ...
    public string GetJobApplication() {
      string background = $@"Он был рождён во времена драконов,{name}, {fromUniverse}, тут не ценят героев, драконы давно захватили эти земли" +
                          "и у людей не осталось надежды, из-за нехватки людей драконы стали размножаться с людьми, чтобы использовать их рабочую силу по максимуму, так и родился " +
                          $@"наш {name} {species}, он {power}, но это сыграет роль в будущем, из-за того, что его мать страдает от отца Прафизизауруса он ненавидит драконов," +
